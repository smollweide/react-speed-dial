...
const props = {
	SpeedDial: {
		...
		icon: {
			...
			required: false,
			desc:
				'This is the `Icon` element to be displayed as icon of the ' +
		...
		positionV: {
			...
			required: false,
			desc:
				'This string controls the vertical `FloatingActionButton` position. ' +
		...
		positionH: {
			...
			required: false,
			desc:
				'This string controls the horizontal `FloatingActionButton` position. ' +
		...
		tabIndex: {
			...
			required: false,
			desc:
				'This is the index to define the tabIndex for the `FloatingActionButton`. The backdrop has tabIndex + 1.',
		},
		toolbox: {
			type: 'object',
			required: false,
	...
	BubbleList: {
		alignment: {
			...
			required: false,
			desc:
				'This string controls the `BubbleList` alignment. ' +
		...
		direction: {
			...
			required: false,
			desc:
				'This string controls the `BubbleList` direction. ' +
	...
	return (
		<div className="table-props prop-type-description">
			...
			<table>
				...
				<tbody>{Object.keys(props[componentName]).map(renderRow)}</tbody>
			</table>
		</div>
	);
};
